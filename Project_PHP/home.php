...
<section class="slider">
    <section class="slider">
        <div class="slideshow-container">
            <img class="slide active" src="/assets/images/slide-1.jpg" alt="Ảnh khách sạn 1">
            <img class="slide active" src="/assets/images/slide-2.jpg" alt="Ảnh khách sạn 2">
            <img class="slide active" src="/assets/images/slide-3.jpg" alt="Ảnh khách sạn 3">
            <img class="slide active" src="/assets/images/slide-4.jpg" alt="Ảnh khách sạn 4">
    ...
    <section class="highlights-section">
        ...
        <div class="highlights-grid">
            ...
            <div class="highlight-item">
                ...
                <a href="/views//services.php" class="btn btn-primary">Khám Phá Tiện Ích</a>
            </div>
