...
<section class="slider">
    <section class="slider">
        <div class="slideshow-container">
            ...
            <img class="slide" src="/assets/images/slide-2.jpg" alt="Ảnh khách sạn 2">
            <img class="slide" src="/assets/images/slide-3.jpg" alt="Ảnh khách sạn 3">
            <img class="slide" src="/assets/images/slide-4.jpg" alt="Ảnh khách sạn 4">
