...
<link rel="stylesheet" href="/Project_PHP//assets//css//support.css">
    ...
    <section class="support-section faq-section">
        ...
        <div class="faq-grid">
            <div class="faq-item">
                ...
                <p>Để đặt phòng, bạn cần truy cập trang <a href="/Project_PHP/index.php">"Trang Chủ"</a> hoặc <a href="/Project_PHP/views/bookedRoom.php">"Phòng Đã Đặt"</a>, chọn ngày đến và ngày đi, số lượng khách, sau đó chọn loại phòng và tiến hành thanh toán. Bạn cần có tài khoản để hoàn tất việc đặt phòng.</p>
            </div>
            <div class="faq-item">
            ...
            <div class="faq-item">
                ...
                <p>Bạn có thể đặt thêm dịch vụ tại trang <a href="/Project_PHP/services.php">"Dịch Vụ"</a> hoặc trong quá trình đặt phòng. Sau khi đặt phòng thành công, bạn cũng có thể quản lý và thêm dịch vụ thông qua trang <a href="/Project_PHP/views/bookedRoom.php">"Phòng Đã Đặt"</a> của mình.</p>
            </div>
            <div class="faq-item">
            ...
            <div class="faq-item">
                ...
                <p>Để hủy hoặc thay đổi đặt phòng, vui lòng <b><a href="/Project_PHP/login.php">đăng nhập</a></b> vào tài khoản của bạn, truy cập trang <a href="/Project_PHP/views/bookedRoom.php">"Phòng Đã Đặt"</a> và chọn đặt phòng muốn thay đổi. Lưu ý các chính sách hủy/thay đổi có thể áp dụng phí hoặc giới hạn thời gian.</p>
            </div>
        </div>
    </section>
